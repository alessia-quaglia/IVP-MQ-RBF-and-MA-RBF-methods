...
for i = 1:length(N)
    ...
    err_MQeulerC2_1(i) = RBF_eulerC2(f, u_exact, a, b, u0, n, 1, 0, 1);
    err_MQeulerC2_2(i) = RBF_eulerC2(f, u_exact, a, b, u0, n, 1, h^(-1), 1);
    err_MQeulerC2_3(i) = RBF_eulerC2(f, u_exact, a, b, u0, n, 0.5, h^(-0.5), 1);
end
