function [err1, err2] = ab2_sys(f, u_es1, u_es2, a, b, u0, N)
%
% Usage:     [err1, err2] = ab2_sys(f, u_es1, u_es2, a, b, u0, N)
% Purpose:   it solves a system of 2 first order differential equations 
%            u'(t) = f(u(t),t) with an initial condition u(a) = u0 
%            and computes the global error for both components using 
