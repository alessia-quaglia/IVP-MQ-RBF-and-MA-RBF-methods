function [err1, err2] = euler_sys(f, u_es1, u_es2, a, b, u0, N)
%
% Usage:     [err1, err2] = euler_sys(f, u_es1, u_es2, a, b, u0, N)
...
%            the global error for both components using Euler's method
